  ...
  return (
    <Wrapper ref={refHome}>
      ...
      <main>
        ...
        <section className="SocialMedia" data-aos="fade-up" data-aos-delay="400" ref={refContato}>
          <span>Contato</span>
          <div className="iconsLinksContainer">
            <Link to={"https://github.com/Gutemberg149"} target="_blank">
              <div className="boxIcon">
                <LuGithub className="iconSocial" />
              </div>
            </Link>
            <Link to={"https://www.linkedin.com/in/gutemberg-rocha-28757361/"} target="_blank">
              <div className="boxIcon">
                <BiLogoLinkedin className="iconSocial" />
              </div>
            </Link>
            <Link to={"https://www.instagram.com/guga.silva84/"} target="_blank">
              <div className="boxIcon">
      ...
      .iconsLinksContainer {
        ...
        .boxIcon {
          ...
          &:hover {
            ...
            box-shadow: rgba(45, 48, 237, 0.12) 0px 8px 12px 0px, rgba(71, 162, 201, 0.32) 0px 2px 16px 0px;
          }
          .iconSocial {
            font-size: 3rem;
            margin: 8rem 1rem;
